...
--]]
--== Configuration;
local defaultDatabase = "https://infinitum-2bf22.firebaseio.com/"; -- Set your database link
	...
	**--]]
	function Firebase:GetAsync(directory)
		...
		local tries = 0; repeat until pcall(function() tries = tries +1;
			data = HttpService:GetAsync(databaseName..HttpService:UrlEncode(directory and "/"..directory or "")..".json", true);
		end) or tries > 2;
